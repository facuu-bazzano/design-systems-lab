...
export const defaultSemanticTokens = (): SemanticToken[] => [
  semantic("surface-default", "surface.default", "Superficie", "Slate.50", "Lienzo principal", "Slate.900"), semantic("surface-raised", "surface.raised", "Superficie", "#FFFFFF", "Contenedores elevados", "Slate.800"), semantic("surface-overlay", "surface.overlay", "Superficie", "Slate.900@72", "Overlays con alpha incorporado", "Slate.900@76"),
  semantic("text-primary", "text.primary", "Texto", "Slate.900", "Texto principal", "Slate.50"), semantic("text-muted", "text.muted", "Texto", "Slate.600", "Texto secundario", "Slate.300"), semantic("text-on-action", "text.on-action", "Texto", "#FFFFFF", "Contenido sobre acciones", "#FFFFFF"),
  ...
  semantic("feedback-success", "feedback.success", "Feedback", "Emerald.700", "Confirmación positiva", "Emerald.500"), semantic("feedback-warning", "feedback.warning", "Feedback", "Amber.700", "Advertencia", "Amber.500"), semantic("feedback-destructive", "feedback.destructive", "Feedback", "Rose.700", "Error o acción destructiva", "Rose.600"),
...
export function allColorReferences(project: DesignSystemProject) { return ["#FFFFFF", "#000000", ...project.foundations.colors.flatMap((item) => colorSteps.map((step) => `${item.name}.${step}`))]; }
